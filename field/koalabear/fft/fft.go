...
func kerDIFNP_32generic(a []koalabear.Element, twiddles [][]koalabear.Element, stage int) {
	n := 1 << 5
	m := n >> 1
	split := 1
	...
	for step := 0; step < 5; step++ {
		...
		if m > 8 {
			...
			for offset := 0; offset < bound; offset += n {
				...
				for i := 0; i < m; i++ {
					koalabear.Butterfly(&aa[i], &aa[i+m])
...
func kerDITNP_32generic(a []koalabear.Element, twiddles [][]koalabear.Element, stage int) {
